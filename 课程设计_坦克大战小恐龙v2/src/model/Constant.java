...
public class Constant {
    ...
    public final static int grassWidth = 20;
    ...
    public final static String dinosaur_Img_left = "image/tank/dinosaur-1.png";
    public final static String dinosaur_Img_right = "image/tank/dinosaur.png";
    ...
    public final static String grass_Img = "image/map/Grass.png";
    public final static String Player2_Img_upImg = "image/tank/GoodTank1_up.png";
    public final static String Player2_Img_leftImg = "image/tank/GoodTank1_left.png";
    public final static String Player2_Img_rightImg = "image/tank/GoodTank1_right.png";
    public final static String Player2_Img_downImg = "image/tank/GoodTank1_down.png";
